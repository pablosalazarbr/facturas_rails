...
class FacturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post facturas_url, params: { factura: { cliente_id: @factura.cliente_id, observaciones: @factura.observaciones, serie_documento: @factura.serie_documento, total: @factura.total, user_id: @factura.user_id } }
    end
  ...
  test "should update factura" do
    patch factura_url(@factura), params: { factura: { cliente_id: @factura.cliente_id, observaciones: @factura.observaciones, serie_documento: @factura.serie_documento, total: @factura.total, user_id: @factura.user_id } }
